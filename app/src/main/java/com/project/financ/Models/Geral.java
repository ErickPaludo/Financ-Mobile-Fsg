...
public class Geral extends Credito{
    ...
    public Geral(int id, String titulo, String descricao, double valor, String dthrReg, String status, String userId, double valorIntegral, LocalDateTime dataVencimento, int totalParcelas) {
